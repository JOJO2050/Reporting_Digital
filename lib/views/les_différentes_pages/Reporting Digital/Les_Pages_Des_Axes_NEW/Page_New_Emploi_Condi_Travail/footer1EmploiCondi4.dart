...
class footer1EmploiCondi4 extends StatefulWidget {
  const footer1EmploiCondi4({Key? key}) : super(key: key);

  @override
  _footer1EmploiCondi4State createState() => _footer1EmploiCondi4State();
}

class _footer1EmploiCondi4State extends State<footer1EmploiCondi4>
    with SingleTickerProviderStateMixin {
  late AnimationController _controller;

  // Distance à laquelle la footer1EmploiCondi4 doit s'arrêter (en pixels)
