...
class buttonImpact extends StatefulWidget {
  @override
  _buttonImpactState createState() => _buttonImpactState();
}

class _buttonImpactState extends State<buttonImpact> {
    ...
    return MouseRegion(
      ...
      child: Container(
        ...
        child: ElevatedButton(
          onPressed: () {
            Navigator.push(
                context, MaterialPageRoute(builder: (_) => ImpactPage()));
          },
          style: ButtonStyle(
